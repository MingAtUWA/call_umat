        !COMPILER-GENERATED INTERFACE MODULE: Fri May 08 12:32:55 2020
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE UMAT_HYPOPLASTICITY__genmod
          INTERFACE 
            SUBROUTINE UMAT_HYPOPLASTICITY(STRESS,STATEV,DDSDDE,SSE,SPD,&
     ...
     &,PNEWDT,CELENT,DFGRD0,DFGRD1,NOEL,NPT,LAYER,KSPT,KSTEP,KINC)
          ...
          END INTERFACE 
        END MODULE UMAT_HYPOPLASTICITY__genmod
