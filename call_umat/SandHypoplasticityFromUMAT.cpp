...
extern "C"
{
	void _cdecl SAND_HYPOPLASTICITY_INTEGRATION(
		double stress[6], 
		double ddsdde[6][6],
		double statev[13],
		double dstran[6],
...
SandHypoplasticityFromUMAT::SandHypoplasticityFromUMAT() :
	ConstitutiveModel(&SandHypoplasticityFromUMAT_integration_func,
		ConstitutiveModelType::SandHypoplasticityFromUMAT)
{
...
void SandHypoplasticityFromUMAT::set_param(
...
{
	SandHypoplasticityFromUMAT& self = *static_cast<SandHypoplasticityFromUMAT *>(_self);
